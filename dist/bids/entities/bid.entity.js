...
__decorate([
    (0, swagger_1.ApiProperty)({
        example: 'AETZ – 2026 – 1',
        description: 'Уникальный номер заявки (AETZ – год – порядковый номер)',
    }),
...
__decorate([
    (0, swagger_1.ApiProperty)({
        description: 'Все данные заявки (v2: config/snapshot/pricingMeta/repriceDiff, с поддержкой legacy)',
        example: {
            bmz: {
                buildingType: 'bmz',
                length: 5000,
